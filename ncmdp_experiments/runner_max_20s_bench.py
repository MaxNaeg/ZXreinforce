...
# We used seeds 0, 1, 2, 3, 4 for the experiments
...
parser.add_argument("--extra_state_info", default=True, type=str, 
                    help="extra_state_info")

parser.add_argument("--adapted_reward", default=True, type=str, 
                    help="adapted_reward")
...
add_dir=f"{extra_state_info=}_{adapted_reward=}_{seed=}_"
...
if COPY_Files:
    shutil.copyfile("runner_max_20s_bench.py", 
                    str(exp_dir / "runner_max_20s_bench.py"))
