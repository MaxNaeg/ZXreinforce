...
parser.add_argument("--extra_state_info", default=True, type=bool, 
                    help="extra_state_info")

parser.add_argument("--adapted_reward", default=True, type=bool, 
                    help="adapted_reward")
...
extra_state_info=args["extra_state_info"]
